...
class TopGainer extends StatefulWidget {
  ...
  @override
  _TopGainer createState() => _TopGainer();
}

class _TopGainer extends State<TopGainer> with SingleTickerProviderStateMixin{
                          ...
                          Padding(
                            ...
                            child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => TopLoser()),
                                  );
                                }, // Image tapped
                                child: Container(
